 ...
 * Systems     : ANSI C, Windows NT (MSVC), 32 bit DOS (Watcom) etc.
 ...
 *
 * Copyright (c) 1998-99 Active Silicon Ltd.
 ****************************************************************************
 * File History
 * ------------
 * See cda_api.h for overall library release information.
 *
 * 01-Jan-98, HCP, Generated.
 * 18-May-98, HCP, TCS release.
 * 22-May-00, LVR, Add Linux.
 * 29-Sep-00, LVR, Added WINBASEAPI to IsDebuggerPresent prototype.
 * 27-Sep-01, CLR, Added MacOS X support.
 *
 * Comments:
 * --------
 ...
 * ------------------------------------
 * 1. "_CDA_WINNT" - Windows NT (defines _CDA_WIN32)
 * 2. "_CDA_WIN95" - Windows 95 (defines _CDA_WIN32)
 * 3. "_CDA_DOS32" - 32 bit DOS (Symantec etc)
 * 4. "_CDA_ARM7"  - 32 bit ARM7 architecture/SDT
 * 5. "_CDA_LINUX" - Linux 2.0.0 & later with GCC 2.95.2 or later
 *
 *
 ...
 * 6. Assertion macros (included if _CDA_DEBUG defined).
 * 7. Debug macros.
 *
 ****************************************************************************
 */
