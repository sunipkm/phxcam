 ...
 * 6. "_PHX_QNX6"    - QNX 6.21/Neutrino and above
 *
...
#if defined _PHX_WIN32 || defined _PHX_WIN64
/*===========================================================================*/

#if defined _PHX_WIN64 && !defined _WIN64
   #error You have defined _PHX_WIN64 in a non 64-bit environment
#endif
...
*/
   ...
   #define _CDA_WIN32
#endif
#if !defined _PDL_WIN32
   #define _PDL_WIN32
#endif
#if !defined _PBL_WIN32
   #define _PBL_WIN32
#endif
 ...
 */
#define PHX_INLINE __inline
#if defined _PHX_USEDLLS
  #define PHX_EXPORT_FN   __declspec(dllimport)
  #define PHX_EXPORT_PFN  __declspec(dllimport)*
  #define PHX_EXPORT_DATA __declspec(dllimport)
#else
  #define PHX_EXPORT_FN   __declspec(dllexport)
  #define PHX_EXPORT_PFN  __declspec(dllexport)*
